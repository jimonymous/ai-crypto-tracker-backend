...
export interface PremiumPassInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface PremiumPass extends BaseContract {
  connect(runner?: ContractRunner | null): PremiumPass;
  waitForDeployment(): Promise<this>;

  interface: PremiumPassInterface;
